...
<html>
  ...
  <form role="form" method="post">
   <input type="hidden" name="_token" value="{{ csrf_token() }}" />
    <input id="origin-input" name="from" class="controls" type="text" placeholder="Enter an origin location">
...
<button type="submit" class="btn btn-primary">Login</button>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBuhdse5XZbloZe92_8pSzFLheUY20__Yo&libraries=places&callback=initMap"
        async defer></script>
  </body>
</html>
